...
const mip_groups_components = {
    ...
    <div class="mip-table-container" style="height:100%; margin:0; border:1px solid #a3bae9; overflow-y:auto; background:#fff;">
    <table class="mip-grid">
    <thead>
    <tr style="background: linear-gradient(to bottom, #f9fbfd, #e2eefb); height:22px; border-bottom:1px solid #a3bae9">
    <th style="width:50%; color:#15428b; font-weight:normal; padding:2px 6px">Module Name</th>
    <th style="width:25%; color:#15428b; font-weight:normal; text-align:center; padding:2px 6px">Read</th>
    <th style="width:25%; color:#15428b; font-weight:normal; text-align:center; padding:2px 6px">Write</th>
    </tr>
    </thead>
    <tbody id="w-rights-tbody"></tbody>
    </table>
    </div>
    </div>`
};
